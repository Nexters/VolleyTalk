 ...
 */
public class DetailTeamAlbumAdapter extends BaseAdapter {
    ...
    public DetailTeamAlbumAdapter(Context context, PostAllModelRetro postAllModelRetro) {
        this.context = context;
        this.postAllModelRetro = postAllModelRetro;
        this.layout = R.layout.item_rv_album;
...
//        final PostAllModel postAllModel = postAllModelRetro.getList().get(position);
        ...
        Glide.with(context)
                .load("http://dimg.donga.com/wps/SPORTS/IMAGE/2017/08/24/85970420.2.jpg")
                .into(viewHolder.iv_item_rv);
