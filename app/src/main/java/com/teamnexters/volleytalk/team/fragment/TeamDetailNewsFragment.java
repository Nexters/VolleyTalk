...
import com.teamnexters.volleytalk.team.adapter.DetailTeamNewsAdapter;
 ...
 * {@link TeamDetailNewsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TeamDetailNewsFragment#newInstance} factory method to
 * create an instance of this fragment.∂
 */
public class TeamDetailNewsFragment extends Fragment {
...
//    private VideoGridAdapter adapter;
    ...
    public static TeamDetailNewsFragment newInstance(String category_type, String language, int position) {
        TeamDetailNewsFragment fragment = new TeamDetailNewsFragment();
...
//        initGridView(view);
    ...
    private void initListView(View view) {
        ...
        detailTeamNewsAdapter = new DetailTeamNewsAdapter(getContext(), postAllModelRetro);
        listView.setAdapter(detailTeamNewsAdapter);
