...
import com.teamnexters.volleytalk.team.adapter.DetailTeamPlayerAdapter;
 ...
 * {@link TeamDetailPlayerFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TeamDetailPlayerFragment#newInstance} factory method to
 * create an instance of this fragment.∂
 */
public class TeamDetailPlayerFragment extends Fragment {
...
//    private VideoGridAdapter adapter;
    ...
    private DetailTeamPlayerAdapter detailTeamPlayerAdapter;
    private PostAllModelRetro postAllModelRetro;


    private Call<TeamModelRetro> mainModelCall;

    public TeamDetailPlayerFragment() {
    ...
    public static TeamDetailPlayerFragment newInstance(String category_type, String language, int position) {
        TeamDetailPlayerFragment fragment = new TeamDetailPlayerFragment();
...
//        initListView(view);
    ...
    private void initListView(View view) {
        ...
        detailTeamPlayerAdapter = new DetailTeamPlayerAdapter(getContext(), postAllModelRetro);
        listView.setAdapter(detailTeamPlayerAdapter);
