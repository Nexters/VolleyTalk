...
//        RecyclerView ro_view = (RecyclerView) rootView.findViewById(R.id.gridView);
...
//        RadioButton rb_female_team = (RadioButton) ro_view.findViewById(R.id.rb_female_team);
        ...
        TeamAdapter2 teamAdapter2 = new TeamAdapter2(teamList, context);
//        ro_view.setAdapter(teamAdapter2);
