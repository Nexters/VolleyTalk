 ...
 */
public class DetailTeamResultAdapter extends BaseAdapter {
    ...
    public DetailTeamResultAdapter(Context context, PostAllModelRetro postAllModelRetro) {
        this.context = context;
        this.postAllModelRetro = postAllModelRetro;
        this.layout = R.layout.item_lv_text_result;
